...
public class CategoryAdapter extends RecyclerView.Adapter<com.example.quiz.CategoryAdapter.Viewholder> {
        ...
        private void setData(String url,final String title,final int sets){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent setIntent=new Intent(itemView.getContext(), com.example.quiz.SetsActivity.class);
